...
import TemplateAlert from "@/components/common/TemplateAlert";
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      <div className="max-w-md mx-auto px-4 py-6">
        <TemplateAlert message="This section is for preview purposes only. Actual bookings cannot be made through the web builder. However, once your website is deployed, booking functionality will be enabled. " />
        <div className="text-center mb-6">
          <h1 className="text-xl font-medium text-black">Book My Tour</h1>
          <p className="text-sm text-gray-500 mt-1">
            Thank you for choosing us! and for your support of responsible
            tourism.
          </p>
        </div>
        ...
        {currentStep === 1 && (
          ...
          <div className="mb-6">
            ...
            {/* Continue Button */}
            <Button
              className="w-full font-medium py-3 rounded-md"
            ...
            {additionalTravelers.map((travelerIndex) => (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    <Label
                      htmlFor={`firstName${travelerIndex}`}
                  ...
                  <div>
                    <Label
                      htmlFor={`lastName${travelerIndex}`}
                      className="text-sm mb-1.5 block"
                    >
                      Last Name<span className="text-red-500">*</span>
                    </Label>
                ...
                <div className="mb-4">
                  <Label
                    htmlFor={`birthDate${travelerIndex}`}
                    className="text-sm mb-1.5 block"
                  >
                    Date of Birth<span className="text-red-500">*</span>
                  </Label>
                ...
                <div className="mb-4">
                  ...
                  <RadioGroup defaultValue="male" className="flex gap-4 mt-1">
                    <div className="flex items-center">
                      <RadioGroupItem
                        value="male"
                        id={`male${travelerIndex}`}
                        className="mr-2"
                      />
                      <Label
                        htmlFor={`male${travelerIndex}`}
                    ...
                    <div className="flex items-center">
                      <RadioGroupItem
                        value="female"
                        id={`female${travelerIndex}`}
                        className="mr-2"
                      />
                      <Label
                        htmlFor={`female${travelerIndex}`}
                        className="text-sm font-normal"
                      >
                        Female
                      </Label>
                ...
                <div className="mb-4">
                  <Label
                    htmlFor={`nationality${travelerIndex}`}
                    className="text-sm mb-1.5 block"
                  >
                    Nationality<span className="text-red-500">*</span>
                  </Label>
                  ...
                  <div className="flex items-center justify-between rounded-md border border-gray-200 p-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="w-10 h-5 bg-blue-500 rounded flex items-center justify-center">
                        <div className="text-white text-[6px] font-bold">
                          AMERICAN EXPRESS
                        </div>
                      </div>
                    </div>
