...
import { PAGE_DETAILS } from "../../../projects/_graphql/queries";
...
export default function TourBoilerPlateHome() {
  ...
  const { data: pageData } = useQuery(PAGE_DETAILS, {
    variables: {
      slug: pageName,
    },
    context: {
        ...
        <Suspense fallback="Loading">
          {sections.map((section: PageItem) => {
            switch (section.type) {
                    ...
                    <div className="container mx-auto px-4">
                      ...
                      <div className="flex flex-wrap items-center">
                        ...
                        exciting tours, we're passionate about helping you create memories that last a lifetime.`}
                          ...
                          <p className="text-lg mb-4">
                            Our team of experienced travel enthusiasts is
                            dedicated to providing you with top-notch service,
                            ensuring every aspect of your journey is carefully
              ...
              // case "newsBlogs":
              //   return <JourneyCardGrid key={section.id} />;
              case "form":
                return (
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                      <div className="text-center text-white">
                        ...
                        <p className="text-xl mb-8">
                          Explore the world with our exciting tour packages
                        </p>
